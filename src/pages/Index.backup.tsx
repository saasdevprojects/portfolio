          ...
          <div className="container px-4 mx-auto">
            ...
            <div className="relative max-w-5xl mx-auto">
              <div className="embla overflow-hidden">
                <div className="embla__container flex">
                  {filteredImages.map((image, index) => (
                    <div key={index} className="embla__slide flex-[0_0_100%] min-w-0 px-4">
                      <div className="relative group overflow-hidden rounded-xl shadow-xl bg-background">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-end p-6">
                          <div className="translate-y-4 group-hover:translate-y-0 transition-transform duration-300">
                            <span className="inline-block px-3 py-1 text-xs font-medium rounded-full bg-primary/90 text-primary-foreground mb-2">
                              {image.category.split('-').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}
                            </span>
                            <h3 className="text-2xl font-bold text-white mb-1">{image.alt}</h3>
                ...
                {/* Navigation Buttons */}
                <button 
                  className="embla__prev absolute left-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-background transition-colors -ml-4"
                ...
                <button 
                  className="embla__next absolute right-0 top-1/2 -translate-y-1/2 z-10 w-10 h-10 rounded-full bg-background/80 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-background transition-colors -mr-4"
                ...
                <div className="flex justify-center mt-8 gap-2">
                  {filteredImages.map((_, index) => (
                    <button 
                      key={index}
                      className="w-2.5 h-2.5 rounded-full bg-muted-foreground/30 embla__dot transition-all duration-300"
